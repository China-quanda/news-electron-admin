		...
		<el-card class="box-card">
			<el-form ref="searchFormRef" :model="searchForm" label-width="80px" status-icon>
				<el-row :gutter="20">
					...
					<el-col :span="6">
						<el-form-item label="字典标签"><el-input v-model="searchForm.label" /></el-form-item>
					</el-col>
					<el-col :span="6">
		...
		<el-dialog v-model="dialogVisible" title="编辑" draggable @close="closeDialog">
			<el-form ref="dictFormRef" :model="dictForm" :rules="dictRules" label-width="80px" status-icon>
				<el-form-item label="字典类型">
					<el-input v-model="dictForm.type" disabled />
					</el-form-item>
				...
				<el-form-item label="字典备注" >
					<el-input v-model="dictForm.remark" type="textarea" placeholder="请输入字典备注"/></el-form-item>
			</el-form>
			<template #footer>
